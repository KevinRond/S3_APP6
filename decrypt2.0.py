...
if __name__ == "__main__":
    # calcul pour dechiffrer le fichier salaires.mm
    e = 1009
    ...
    cle = modular_pow(g, d, n) # Permet d'obtenir la cle pour decrypter avec flux.py le fichier salaires.mm
    # print('cle = ', cle)

    # Calcul pour dechiffrer les salaires dans le fichier partiellement decrypter.
    e = 13
